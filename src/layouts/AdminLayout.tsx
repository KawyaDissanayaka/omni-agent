  ...
  return (
    <div className="flex min-h-screen bg-slate-100/90 text-slate-800 font-sans relative">
      ...
      >
        ...
        <div className="pt-4 pb-3.5 px-4 border-b border-slate-200/80 flex items-center justify-between bg-white">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-12 h-10 overflow-hidden flex items-center justify-center rounded-xl bg-white border border-slate-200 shadow-2xs group-hover:border-indigo-300 transition-all">
              <img 
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-extrabold text-indigo-600 tracking-wider uppercase mt-1">
      ...
      <div className="flex-1 md:ml-[270px] flex flex-col min-h-screen w-full min-w-0 bg-gradient-mesh">
        ...
        <header className="h-16 flex items-center justify-between px-4 sm:px-8 z-10 sticky top-0 bg-white/90 backdrop-blur-md border-b border-slate-200 text-slate-800 shadow-2xs">
          ...
          <div className="flex items-center gap-3 sm:gap-6 text-xs font-semibold">
            ...
            <div className="hidden lg:flex items-center gap-3 px-3.5 py-1.5 bg-white rounded-xl border border-slate-200 shadow-2xs">
              <span className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Partnered with</span>
              <div className="w-px h-5 bg-slate-200" />
              <img src="/the-embryo-logo.jpg" alt="The Embryo Innovation Centre" className="h-8 sm:h-9 object-contain" />
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs font-semibold">
                <li><Link to={isAdminMode ? "/admin/dashboard" : "/dashboard"} className="hover:text-indigo-600 text-slate-600 transition-colors">Dashboard</Link></li>
                <li><Link to={isAdminMode ? "/admin/chat" : "/chat"} className="hover:text-indigo-600 text-slate-600 transition-colors">Live ChatBot</Link></li>
                <li><Link to={isAdminMode ? "/admin/channels" : "/channels"} className="hover:text-indigo-600 text-slate-600 transition-colors">Omni Channels</Link></li>
                <li><Link to={isAdminMode ? "/admin/agents" : "/agents"} className="hover:text-indigo-600 text-slate-600 transition-colors">AI Agents</Link></li>
                <li><Link to={isAdminMode ? "/admin/api-management" : "/api"} className="hover:text-indigo-600 text-slate-600 transition-colors">API Management</Link></li>
              </ul>
            </div>
