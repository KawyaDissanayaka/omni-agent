    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white/95 backdrop-blur-xl p-8 rounded-3xl border border-slate-200 shadow-xl space-y-4">
            <h2 className="text-xl font-black text-indigo-600 mb-3">
              Data We Collect
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-slate-50 text-slate-900 p-5 rounded-2xl border border-slate-200">
            ...
            <div className="mt-6 rounded-2xl bg-indigo-600 p-6 text-white text-center relative overflow-hidden shadow-lg border border-indigo-500">
              <div className="relative z-10">
                ...
                <p className="text-xs text-indigo-100 mt-1 max-w-lg mx-auto font-medium">
          ...
          <div className="bg-white/95 backdrop-blur-xl p-8 rounded-3xl border border-slate-200 shadow-xl space-y-3">
            <h2 className="text-xl font-black text-indigo-600 mb-3">
              How We Use Your Data
            </h2>
            <div className="space-y-3 text-xs sm:text-sm text-slate-600 font-medium">
              <p>
                • <strong className="text-slate-900 font-black">Provide AI Agent Functionality:</strong> Processing user queries through channel endpoints (WhatsApp, Messenger, Web).
              </p>
              <p>
                • <strong className="text-slate-900 font-black">Analytics &amp; Monitoring:</strong> Tracking response accuracy, latency, and usage metrics across tenants.
              </p>
              <p>
                • <strong className="text-slate-900 font-black">Security Verification:</strong> Verifying administrative actions and preventing unauthorized tenant breaches.
              </p>
            </div>
          </div>
